...
silent only
cd ~/Documents/school/4702/lab1/lab1
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +148 pv_encrypt.c
badd +1 pv_keygen.c
badd +162 pv_decrypt.c
badd +1 pv_misc.c
badd +1 pv.h
badd +1 notes
badd +1 pv_encrypt
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 37 - ((0 * winheight(0) + 28) / 57)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
37
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 184 - ((55 * winheight(0) + 28) / 57)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
184
